...
const INITIAL_DISCUSSIONS: Discussion[] = [
  {
    ...
    avatar: "SG",
    title:
      "Reox v1.1: UI Constructs Are Here — variant, layer, panel, protocol & More",
    content:
      "We just shipped a major update to Reox! The compiler now supports 7 new language constructs for building native UIs: variant (tagged unions), protocol (vtable interfaces), extension (type methods), layer (reactive view components with signals and gesture handlers), panel (top-level windows), const, and typealias. All constructs compile end-to-end to optimized C. 112 tests pass. Check the updated docs for examples.",
    category: "announcement",
    timestamp: new Date("2026-03-03T17:00:00"),
    replies: 0,
    likes: 0,
  },
  {
  ...
  },
  {
    ...
    content:
      "This is the official community forum for Reox developers. Ask questions, share your projects, and connect with other developers building native UIs with Reox.",
    category: "announcement",
  ...
  },
  {
    ...
    content:
      "I am trying to build a custom date picker widget. What is the best approach for creating reusable components?",
    category: "question",
  ...
  },
  {
    ...
    content:
      "We are excited to announce the release of Reox 0.5.0-beta with interpreter improvements, package manager foundation, and more. Check the blog for details!",
    category: "announcement",
  ...
  },
  {
    ...
    content:
      "Just finished building my first app with Reox! A simple todo list that runs natively on NeolyxOS. The declarative syntax is amazing!",
    category: "showcase",
...
export default function CommunityPage() {
  ...
  const [newPost, setNewPost] = useState({
    title: "",
    content: "",
    category: "discussion" as Discussion["category"],
  });
  ...
  const handleSubmitPost = (e: React.FormEvent) => {
    e.preventDefault();
    if (!newPost.title.trim() || !newPost.content.trim() || !authorName.trim())
      return;
    ...
    const updated = [
      discussion,
      ...discussions.filter(
        (d) => !INITIAL_DISCUSSIONS.find((i) => i.id === d.id),
      ),
    ];
      ...
      <main className="flex flex-col items-center w-full max-w-6xl px-6 py-20">
        ...
        <div className="text-center mb-12 animate-fade-in-up pt-12">
          <h1 className="text-5xl font-bold mb-6">
            Reox <span className="text-gradient">Community</span>
          </h1>
          <p className="text-xl text-gray-400 max-w-2xl mx-auto">
            Connect with developers, ask questions, share your projects, and
            help shape the future of Reox.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 w-full mb-10">
          <a
            href="https://github.com/ketiveeai/reox"
            target="_blank"
            className="glass p-5 rounded-xl border border-white/10 hover:border-primary/50 transition-all group flex items-center gap-4"
          >
          ...
          <a
            href="https://github.com/ketiveeai/reox/discussions"
            target="_blank"
            className="glass p-5 rounded-xl border border-white/10 hover:border-green-500/50 transition-all group flex items-center gap-4"
          >
          ...
          <a
            href="https://x.com/ketiveeai"
            target="_blank"
            className="glass p-5 rounded-xl border border-white/10 hover:border-blue-400/50 transition-all group flex items-center gap-4"
          >
                ...
                <div className="flex items-center gap-4">
                  <select
                    ...
                    onChange={(e) =>
                      setNewPost({
                        ...newPost,
                        category: e.target.value as Discussion["category"],
                      })
                    }
                ...
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    ...
                    <span className="text-gray-500 text-sm ml-2">
                      {formatTime(selectedDiscussion.timestamp)}
                    </span>
                  </div>
                  <span
                    className={`text-xs px-2 py-1 rounded-full border ${getCategoryColor(selectedDiscussion.category)}`}
                  >
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 mb-1 flex-wrap">
                        <span
                          className={`text-xs px-2 py-0.5 rounded-full border ${getCategoryColor(discussion.category)}`}
                        >
                          {discussion.category}
                        </span>
        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-3 gap-6 mt-10">
          <Link
            href="/docs"
            className="glass p-6 rounded-xl border border-white/10 hover:border-primary/30 transition-all group"
          >
            ...
            <p className="text-sm text-gray-500">
              Learn Reox from the official guides and API reference.
            </p>
          </Link>

          <Link
            href="/blog"
            className="glass p-6 rounded-xl border border-white/10 hover:border-orange-500/30 transition-all group"
          >
            ...
            <p className="text-sm text-gray-500">
              Read announcements, tutorials, and engineering deep-dives.
            </p>
          </Link>

          <Link
            href="/packages"
            className="glass p-6 rounded-xl border border-white/10 hover:border-cyan-500/30 transition-all group"
          >
            <svg
            ...
            <p className="text-sm text-gray-500">
              Browse community packages and share your own.
            </p>
          </Link>
        </div>
      </main>
